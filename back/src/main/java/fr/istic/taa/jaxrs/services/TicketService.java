...
public class TicketService {
    ...
    public long create(final TicketCreateDTO dto) throws ClientErrorException {
        ...
        BigDecimal prix = calculPrixUnitaire(dto.getNumeroPlace());
    ...
    private BigDecimal calculPrixUnitaire(String numeroPlace) {
        // TODO Calcul en fonction du numeroPlace
        return BigDecimal.valueOf(Long.parseLong(numeroPlace) * 10);
    }
}
